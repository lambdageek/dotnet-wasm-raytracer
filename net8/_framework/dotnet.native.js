...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  var worker;
  if (!Module["locateFile"]) {
   worker = new Worker(new URL("dotnet.native.worker.js", import.meta.url));
  } else {
   var pthreadMainJs = locateFile("dotnet.native.worker.js");
...
function ___syscall_faccessat(dirfd, path, amode, flags) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(4, 1, dirfd, path, amode, flags);
 try {
...
function ___syscall_statfs64(path, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(8, 1, path, size, buf);
 try {
  path = SYSCALLS.getStr(path);
...
function ___syscall_fstatfs64(fd, size, buf) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(7, 1, fd, size, buf);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function ___syscall_unlinkat(dirfd, path, flags) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(18, 1, dirfd, path, flags);
 try {
  path = SYSCALLS.getStr(path);
  path = SYSCALLS.calculateAt(dirfd, path);
  if (flags === 0) {
...
function __mmap_js(len, prot, flags, fd, off, allocated, addr) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(19, 1, len, prot, flags, fd, off, allocated, addr);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function __munmap_js(addr, len, prot, flags, fd, offset) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(20, 1, addr, len, prot, flags, fd, offset);
 try {
  var stream = SYSCALLS.getStreamFromFD(fd);
  if (prot & 2) {
...
function _fd_pread(fd, iov, iovcnt, offset, pnum) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(24, 1, fd, iov, iovcnt, offset, pnum);
 try {
...
function _fd_seek(fd, offset, whence, newOffset) {
 if (ENVIRONMENT_IS_PTHREAD) return _emscripten_proxy_to_main_thread_js(26, 1, fd, offset, whence, newOffset);
 try {
  offset = bigintToI53Checked(offset);
  if (isNaN(offset)) return 61;
  var stream = SYSCALLS.getStreamFromFD(fd);
...
function _mono_wasm_eventloop_has_unsettled_interop_promises() {
 return {
  runtime_idx: 37
 };
}
...
function _mono_wasm_pthread_on_pthread_detached() {
 return {
  runtime_idx: 36
 };
}
...
DOTNET.setup({
 ...
 gitHash: "f52a29561c30ccd7475e40a4fb56928738a6eac2"
});

var proxiedFunctionTable = [ null, _proc_exit, exitOnMainThread, pthreadCreateProxied, ___syscall_faccessat, ___syscall_fcntl64, ___syscall_fstat64, ___syscall_fstatfs64, ___syscall_statfs64, ___syscall_ftruncate64, ___syscall_getcwd, ___syscall_getdents64, ___syscall_ioctl, ___syscall_lstat64, ___syscall_newfstatat, ___syscall_openat, ___syscall_readlinkat, ___syscall_stat64, ___syscall_unlinkat, __mmap_js, __munmap_js, _environ_get, _environ_sizes_get, _fd_close, _fd_pread, _fd_read, _fd_seek, _fd_write ];
...
var wasmImports = {
 ...
 "mono_wasm_eventloop_has_unsettled_interop_promises": _mono_wasm_eventloop_has_unsettled_interop_promises,
 ...
 "mono_wasm_install_js_worker_interop": _mono_wasm_install_js_worker_interop,
 ...
 "mono_wasm_pthread_on_pthread_detached": _mono_wasm_pthread_on_pthread_detached,
 ...
 "mono_wasm_uninstall_js_worker_interop": _mono_wasm_uninstall_js_worker_interop,
...
var _mono_aot_RayTracer_get_method = Module["_mono_aot_RayTracer_get_method"] = function() {
 return (_mono_aot_RayTracer_get_method = Module["_mono_aot_RayTracer_get_method"] = Module["asm"]["mono_aot_RayTracer_get_method"]).apply(null, arguments);
};
...
var _mono_aot_System_ComponentModel_Primitives_get_method = Module["_mono_aot_System_ComponentModel_Primitives_get_method"] = function() {
 return (_mono_aot_System_ComponentModel_Primitives_get_method = Module["_mono_aot_System_ComponentModel_Primitives_get_method"] = Module["asm"]["mono_aot_System_ComponentModel_Primitives_get_method"]).apply(null, arguments);
};
...
var _mono_aot_System_ComponentModel_TypeConverter_get_method = Module["_mono_aot_System_ComponentModel_TypeConverter_get_method"] = function() {
 return (_mono_aot_System_ComponentModel_TypeConverter_get_method = Module["_mono_aot_System_ComponentModel_TypeConverter_get_method"] = Module["asm"]["mono_aot_System_ComponentModel_TypeConverter_get_method"]).apply(null, arguments);
};
...
var _mono_aot_System_Drawing_get_method = Module["_mono_aot_System_Drawing_get_method"] = function() {
 return (_mono_aot_System_Drawing_get_method = Module["_mono_aot_System_Drawing_get_method"] = Module["asm"]["mono_aot_System_Drawing_get_method"]).apply(null, arguments);
};

var _mono_aot_System_Drawing_Primitives_get_method = Module["_mono_aot_System_Drawing_Primitives_get_method"] = function() {
 return (_mono_aot_System_Drawing_Primitives_get_method = Module["_mono_aot_System_Drawing_Primitives_get_method"] = Module["asm"]["mono_aot_System_Drawing_Primitives_get_method"]).apply(null, arguments);
};
...
var _mono_aot_System_Threading_Channels_get_method = Module["_mono_aot_System_Threading_Channels_get_method"] = function() {
 return (_mono_aot_System_Threading_Channels_get_method = Module["_mono_aot_System_Threading_Channels_get_method"] = Module["asm"]["mono_aot_System_Threading_Channels_get_method"]).apply(null, arguments);
};
